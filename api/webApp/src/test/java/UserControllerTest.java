...
public class UserControllerTest {
    ...
    public void testbadCredentials() throws Exception {
        ...
        MvcResult result = mockMvc.perform(post("/api/auth/login").content(jsonRequest).contentType(MediaType.APPLICATION_JSON)).andExpect(status().isForbidden()).andReturn();
